...
import { NOODLChainActionPageJumpObject } from '../types'

const mockPageJumpAction: NOODLChainActionPageJumpObject = {
  actionType: 'pageJump',
  destination: 'VideoChat',
}

let action: Action<NOODLChainActionPageJumpObject>
