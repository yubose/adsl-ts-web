...
export function createGlobalComponentId(component: any | string | undefined) {
...
export function getElementType(
  componentMap: Record<ComponentType, string>,
  component: ComponentObject | string,
): t.ElementType {
  if (u.isStr(component)) return componentMap[component] || 'div'
  if (u.isObj(component)) return componentMap[component.type] || 'div'
  return 'div'
}
