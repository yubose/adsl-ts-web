...
class NuiViewport {
  ...
  getWidth(dec: string, rest?: Parameters<typeof NuiViewport['getSize']>[2]) {
    return NuiViewport.getSize(dec, this.width, rest as any)
  }

  getHeight(dec: string, rest?: Parameters<typeof NuiViewport['getSize']>[2]) {
    return NuiViewport.getSize(dec, this.height, rest as any)
  }
}

export default NuiViewport
