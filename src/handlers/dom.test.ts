...
import { getByText, logDOM, prettyDOM, screen } from '@testing-library/dom'
...
describe('parse', () => {
  it('should see the placeholder', () => {
    noodluidom.on('all', F.cbs)
    toDOM({
      type: 'div',
      noodlType: 'view',
      id: 'myid',
      ...
      'data-listid': 'listid123',
    })
    expect(screen.getByPlaceholderText('something'))
  })
