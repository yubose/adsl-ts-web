...
export declare type ElementArg<N extends HTMLElement = HTMLElement> = null | undefined | HTMLElement | HTMLElement[] | HTMLCollection | NodeListOf<N>;
export declare type FileInputEvent = Event & {
    target: Event['target'] & {
        files: FileList;
    };
};
...
export declare type FileSelectorResult = FileSelectorSelectedResult | FileSelectorCanceledResult | FileSelectorErrorResult;
