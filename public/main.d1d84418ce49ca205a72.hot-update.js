...
connection.initDb({
  ...
  await pi.runSql(`update version VALUES (table = CPT, value = 1.0.3);`);
  const res = await pi.runSql(`SELECT * from CPT`);
  console.log(`%c${_tag} SELECT * from CPT`, `color:${_color}`, res);
  pi.use({
    all(evtName, ...args) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("899ada69571f45a58c9d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.d1d84418ce49ca205a72.hot-update.js.map