...
const imageIsMarkeable = new DefaultButton({
    title: "Markeable",
    svg: `
    <svg xmlns="http://www.w3.org/2000/svg" width="13.998" height="13.111" viewBox="0 0 13.998 13.111">
        <path id="路径_23518" data-name="路径 23518" d="M65.213,127.625a1.4,1.4,0,0,0-1.4,1.4v8.4a1.4,1.4,0,0,0,1.4,1.4H69.8l.222-.933H65.213a.465.465,0,0,1-.467-.467v-.864l3.318-3.741,3.332,3.515.656-.663-.554-.588,1.2-1.349.62.649.652-.663-1.291-1.368-1.823,2.053-2.811-2.964-3.3,3.711v-6.129a.466.466,0,0,1,.467-.467H75.48a.466.466,0,0,1,.467.467v3.288a1.778,1.778,0,0,1,.187-.021h.047a2.445,2.445,0,0,1,.7.146v-3.412a1.4,1.4,0,0,0-1.4-1.4Zm7.934,1.867a.933.933,0,1,0,.933.933A.936.936,0,0,0,73.146,129.492Zm2.99,3.737a1.172,1.172,0,0,0-.831.354l-4.354,4.426-.649,2.727,2.727-.646.091-.094,4.338-4.262a1.182,1.182,0,0,0,.007-1.674l-.489-.493A1.167,1.167,0,0,0,76.136,133.229Zm.007.926a.244.244,0,0,1,.175.077l.489.489a.237.237,0,0,1,0,.35l-4.244,4.167-1.006.245.241-1.006,4.174-4.244A.233.233,0,0,1,76.144,134.155Z" transform="translate(-63.813 -127.625)" fill="#595959"/>
    </svg>
    `,
    classFunctions: {
